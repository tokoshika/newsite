  ...
  return (
    <>
      <div className="mainContainer">
        ...
        <p>全体の様子（模型）</p>
        <Image src="/assets/nan01.jpg" width={700} height={450} />
        <p>挹江門</p>
        <Image src="/assets/nan02.jpg" width={700} height={450} />
        <p>玄武門</p>
        <Image src="/assets/nan03.jpg" width={700} height={450} />
        <p>城壁</p>
        <Image src="/assets/nan04.jpg" width={700} height={450} />
      </div>
      <br />
    </>
  );
